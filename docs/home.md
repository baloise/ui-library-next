...
[![Build Status](https://travis-ci.org/baloise/ui-library-next.svg?branch=master)](https://travis-ci.org/baloise/ui-library-next)
[![now](https://badgen.net/badge/icon/now?icon=now&label)](https://ui-library-next.baloise.vercel.app/)
...
Detailed release notes for each version are available on [GitHub](https://github.com/baloise/ui-library-next/blob/master/CHANGELOG.md).
...
<script type="text/javascript">
    ...
    function loadContributors() {
        var url = "https://api.github.com/repos/baloise/ui-library-next/contributors";
