...
| ------------------- | ---------------------------------------------- | ---------------------- |
| `balCheckboxBlur`   | Emitted when the toggle loses focus.           | `CustomEvent<void>`    |
| `balCheckboxChange` | Emitted when the checked property has changed. | `CustomEvent<boolean>` |
| `balCheckboxFocus`  | Emitted when the toggle has focus.             | `CustomEvent<void>`    |
